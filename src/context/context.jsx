  ...
  useEffect(() => {
    try {
      const getSalaryUsers = async () => {
        ...
        const querySnapshot = await getDocs(collection(db, "salaryDetails"));
  ...
  const storeSalaryDetails = async (data2) => {
    try {
      ...
      if (user) {
        ...
        setData(data);
        const querySnapshot2 = await getDocs(collection(db, "salaryDetails"));
...
>>>>>>> a2261bbee54abab56a16fc1143d132f0f9b82939
  ...
  // create a function to delete document from firebase
